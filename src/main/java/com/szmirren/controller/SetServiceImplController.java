...
public class SetServiceImplController extends BaseController {
	 ...
	 */
	public void init() {
		LOG.debug("初始化SetServiceImplController...");
		LOG.debug("初始化SetServiceImplController->初始化属性...");
		// 添加右键删除属性
		...
		LOG.debug("初始化SetServiceImplController->初始化模板文件名选择...");
		...
		LOG.debug("初始化SetServiceImplController->初始化配置信息...");
		...
		initLanguage();
		LOG.debug("初始化SetServiceImplController-->成功!");
	}
